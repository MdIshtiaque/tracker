    ...
    <form action="{{ route('orders.store') }}" method="POST">
        ...
        <div class="row mb-3">
            <div class="col-md-4 mb-3">
                ...
                <input type="text" name="bl_no" value="{{ old('bl_no') }}" placeholder="Enter BL no."
                       class="form-control input-style small-text-12 py-2" id="bl_no"/>
            </div>
            <div class="col-md-4 mb-3">
                <label for="booking_no" class="form-label">Booking No</label>
                <input type="text" name="booking_no" value="{{ old('booking_no') }}" placeholder="Enter Booking no."
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" name="starting_point" value="{{ old('starting_point') }}"
                       placeholder="Enter Starting Point"
                       class="form-control input-style small-text-12 py-2" id="starting_point"/>
            </div>
            <div class="col-md-4 mb-3">
                <label for="destination" class="form-label">Destination</label>
                <input type="text" name="destination" value="{{ old('destination') }}" placeholder="Enter Destination"
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" name="vessel_voy_no" value="{{ old('vessel_voy_no') }}"
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" name="no_of_packages" value="{{ old('no_of_packages') }}"
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="date" name="on_board_date" value="{{ old('on_board_date') }}"
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" name="measurement" value="{{ old('measurement') }}" placeholder="Enter Measurement"
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" name="seal_no" value="{{ old('seal_no') }}"
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" name="moveType" value="{{ old('moveType') }}"
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" name="latest_event" value="{{ old('latest_event') }}"
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" name="vgm" value="{{ old('vgm') }}"
