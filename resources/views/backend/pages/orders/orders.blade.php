                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6">
                        <ol class=" float-right">
                            <a
                                class="btn btn-sm btn-info create" data-toggle="modal"
                        ...
                        <div class="card-body">
                            <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                ...
                                <tr>
                                    ...
                                    {{--                                    @if (Auth::user()->hasPermission('labs.edit') || Auth::user()->hasPermission('labs.show') || Auth::user()->hasPermission('labs.destroy'))--}}
                                ...
                                @foreach ($orders as $key => $order)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a
                                                class="btn btn-sm btn-info status" data-toggle="modal"
